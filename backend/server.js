...
const finisherRoutes = require('./routes/finisher');
...
// Rate limiting
const enableRateLimit = process.env.RATE_LIMIT_ENABLED === 'true' || process.env.NODE_ENV === 'production';
if (enableRateLimit) {
...
app.use('/api/finisher', finisherRoutes);
