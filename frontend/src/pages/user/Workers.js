  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-slate-100">{t('workers.title')}</h1>
        <Button data-tutorial="workers-create-button" onClick={() => (isDemo ? setDemoBlockedOpen(true) : navigate('/user/workers/new'))} icon={Plus} className="w-full sm:w-auto">
