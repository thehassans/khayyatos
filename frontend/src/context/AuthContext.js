...
export const AuthProvider = ({ children }) => {
  ...
  const loginAsFinisher = async (finisherId, userId, adminMode = false) => {
    try {
      const url = (adminMode && userId)
        ? `/admin/users/${userId}/finishers/${finisherId}/login-as`
        : `/finisher/login-as/${finisherId}`;
